...
namespace BomberGame
{
    ...
    public class VerticalPriorityMoveStrategy : PathFindStrategy
    {
        ...
        public VerticalPriorityMoveStrategy(float gridSize , IPositionValidator positionCheck)
        {
        ...
        public override List<Vector2> GetPath(Vector2 start, Vector2 end)
        {
            _prevSteps.Clear();
