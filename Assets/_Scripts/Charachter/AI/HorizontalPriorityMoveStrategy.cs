...
{
    public class HorizontalPriorityMoveStrategy : VerticalPriorityMoveStrategy
    {
        public HorizontalPriorityMoveStrategy(float gridSize, IPositionValidator positionCheck) : base(gridSize,positionCheck)
        {
        }
